...
...
include::{sourcedir}/grace-events-transform/src/test/groovy/grails/events/annotation/PubSubSpec.groovy[tags=publisher]
----
...
...
include::{sourcedir}/grace-events-transform/src/test/groovy/grails/events/ManualPubSubSpec.groovy[tags=publisher]
----
