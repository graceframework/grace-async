...
/**
 * An AST transformation that takes each method in the given class and adds a delegate method
 * that returns a {@link grails.async.Promise} and executes the method asynchronously.
 *
